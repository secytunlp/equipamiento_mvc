...
class SolicitudGridModel extends GridModel {
	...
	public function SolicitudGridModel() {
	...
	protected function initModel() {
		...
		$column = GridModelBuilder::buildColumn( "tipo_equipo.nombre", CYT_LBL_SOLICITUD_TIPO_EQUIPO, 40, CDT_CMP_GRID_TEXTALIGN_LEFT, "$tTipoEquipo.nombre" );
		$this->addColumn( $column );
		...
		/*if (CdtSecureUtils::hasPermission ( $oUser, CYT_FUNCTION_VER_PUNTAJE )) {
			...
			//$this->buildExportXlsAction(CMPSolicitudGrid);
		}*/
