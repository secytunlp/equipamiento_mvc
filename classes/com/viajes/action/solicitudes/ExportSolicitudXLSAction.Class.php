...
class ExportSolicitudXLSAction extends CdtAction{
     ...
     public function execute(){
		...
		if ($oUser->getCd_usergroup()==CYT_CD_GROUP_EVALUADOR) {
			...
			$filter = new CdtSimpleExpression( "(".$tEvaluacionEstado.".estado_oid =".CYT_ESTADO_SOLICITUD_EN_EVALUACION." OR ".$tEvaluacionEstado.".estado_oid =".CYT_ESTADO_SOLICITUD_EVALUADA.")");

			$oCriteriaEvaluacion->setExpresion($filter);
